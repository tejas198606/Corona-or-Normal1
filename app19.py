...
@app.route("/")
def home():
    return render_template("home113.html")                    ## HOME.HTML IS THE TEMPLATE NAME // it can be anything home11.html
...
def upload_file():
    ...
    return render_template(
        "cclassify1111.html", image_file_name=file.filename, label=label, prob=prob) 
